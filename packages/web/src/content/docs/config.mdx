...
- `auto_token_limit` - Explicit token threshold for auto-compaction (clamped to model context headroom).
- `effective_context_percent` - Percent of model context treated as usable before auto-compaction (default: `90`).
